...
const COURSES = ["React", "Node", "UI/UX", "Database", "AI"];
...
export default function StudentForm({ onAdd, editingStudent }) {
  ...
  const validate = () => {
    ...
    if (grade === "" || grade < 0 || grade > 100) newErrors.grade = "Grade must be 0-100";
    setErrors(newErrors);
      ...
      <div className="form-card animated">
        ...
        <form className="form-grid" onSubmit={handleSubmit}>
          <div className="input-group">
            ...
            <input type="text" placeholder="e.g. Rabin Neupane" value={name} onChange={(e) => setName(e.target.value)} />
